                                ...
                                <div class="mb-4 auth-brand">
                                    <a href="{{ route('login') }}" class="logo-dark">
                                        <span class="gap-1 d-flex align-items-center">
                                            <img src="{{ asset('ntra.webp') }}" alt="" class="w-50 rounded-circle">
                                            <span class="logo-text text-body fw-bold fs-xl">لجهاز القومي لتنظيم الاتصالات</span>
                                        </span>
                                    </a>
                                    <a href="{{ route('login') }}" class="logo-light">
                                        <span class="gap-1 d-flex align-items-center">
                                            ...
                                            <span class="text-white logo-text fw-bold fs-xl">لجهاز القومي لتنظيم الاتصالات</span>
                                        </span>
                                    </a>
