...
<body>
    <!-- Header -->
    <header class="px-2 py-2 mb-0 kiosk-header">
    ...
    <main class="container py-0">
        <div class="mb-0 text-center">
            <div class="gap-5 d-flex justify-content-center align-items-center">
                <img src="{{ asset('ntra.webp') }}" alt="NTRA" height="200">
                <img src="{{ asset('ministry.webp') }}" alt="Ministry" height="100">
            </div>
            <h1 class="mb-0 display-6 fw-bold kiosk-title">جهاز الاستعلام الإلكتروني</h1>
        ...
        <div class="row g-4 justify-content-center" style="max-width: 700px; margin: 0 auto;">
            ...
            <div class="col-6">
                <a href="{{ route('imei.check') }}" class="text-decoration-none">
                    <div class="p-2 text-center border-0 shadow service-card card h-100 d-flex flex-column justify-content-center">
