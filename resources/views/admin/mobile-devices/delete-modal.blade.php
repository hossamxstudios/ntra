<div class="modal fade" id="deleteMobileDeviceModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="deleteMobileDeviceForm" method="POST">
                @csrf
                @method('DELETE')
                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <h5>هل أنت متأكد؟</h5>
                        <p class="text-muted">سيتم حذف الجهاز <strong id="delete_device_name"></strong> نهائياً.</p>
                    </div>
                </div>
...
<div class="modal fade" id="bulkDeleteModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="bulkDeleteForm" action="{{ route('admin.mobile-devices.bulk-delete') }}" method="POST">
                @csrf
