...
<div class="sidenav-menu">
    <div class="scrollbar" data-simplebar>
        <div class="p-1 border border-dashed sidenav-user rounded-3">
            <div class="d-flex align-items-center">
                <img src="{{ asset('ntra.webp') }}" width="75" class="flex-shrink-0 rounded-circle ms-2" alt="user-image">
                <div class="overflow-hidden flex-grow-1">
                    <h6 class="my-0 fw-semibold text-truncate fs-4">
