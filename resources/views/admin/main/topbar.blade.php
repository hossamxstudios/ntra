...
<header class="app-topbar">
    <div class="container-fluid topbar-menu">
        <div class="gap-2 d-flex align-items-center justify-content-center">
            <!-- Topbar Brand Logo -->
            <div class="py-1 logo-topbar">
                <a href="{{ route('dashboard') }}" class="logo-dark">
                    <span class="gap-1 d-flex align-items-center">
                        <span class="avatar avatar-xs rounded-circle">
                            <span class="avatar-title">
                                <img src="{{ asset('ntra.webp') }}" height="80" alt="Logo">
                            </span>
                        </span>
                        <span class="logo-text text-body fw-bold fs-xl ms-3">لجهاز القومي لتنظيم الاتصالات</span>
                    </span>
                </a>
            </div>
